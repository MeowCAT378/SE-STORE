            ...
            if (choice.equalsIgnoreCase("Q")) {
                ...
                try {
                    ...
                    if (categoryIndex >= 0 && categoryIndex < categories.size()) {
                        // แสดงรายการสินค้าตาม Category ที่เลือก
                    ...
                    // แสดงข้อความเมื่อผู้ใช้ป้อนข้อมูลไม่ถูกต้อง
